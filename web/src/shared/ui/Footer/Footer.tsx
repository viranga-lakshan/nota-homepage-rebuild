...
export function Footer({ footer }: FooterProps) {
  ...
  return (
    <footer className={styles.footer} id="footer">
      ...
      {/* Separate dedicated Made in Taptop bottom bar */}
      <div className={styles.taptopBar}>
        <a
          href="https://taptop.pro/"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.taptopBarLink}
        >
          {footer?.madeInLogo?.url ? (
            // eslint-disable-next-line @next/next/no-img-element
            <img
              src={footer.madeInLogo.url}
              alt={footer.madeInLogo.alt || "Taptop Logo"}
              className={styles.taptopBarLogo}
            />
          ) : (
            <svg
              width="15"
            ...
            >
              ...
              <rect x="3" y="14" width="7" height="7" rx="1.5" fill="white" fillOpacity="0.4" />
              <rect x="14" y="3" width="7" height="7" rx="1.5" fill="white" fillOpacity="0.4" />
            </svg>
          )}
